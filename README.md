...
**[BLUELINE_V2.md](./BLUELINE_V2.md) is the build bible** (v2 — module grammar, Bonsai pipeline; its §2 laws govern). Build.md is the superseded v1 spec, kept for history. v2 rebuild status: Phases 1-2 complete (score 30) — module grammar (3 plan types, 3 style packs, module self-checks), designer loop, reference-adopted validation checks, interim sheet set (A-000…A-601 subset), SVG elevations, Three.js viewer, /design web view. Bonsai/IFC pipeline, rule verification, and shell remain (Phases 3+). v1 stays runnable at /.
